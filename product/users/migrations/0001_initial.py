...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='AccrualWriteOff',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('_type', models.CharField(choices=[('CA', 'Наличные'), ('NC', 'Безналичный'), ('BO', 'Бонус'), ('GI', 'Подарок'), ('CP', 'Покупка курса'), ('PE', 'Штраф'), ('OT', 'Другое')], db_column='type', max_length=2)),
                ('name', models.CharField(max_length=255)),
                ('dev_code', models.PositiveIntegerField(null=True, unique=True)),
                ('processing_type', models.CharField(choices=[('+', 'Приход'), ('-', 'Расход')], max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('accrual_write_off', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.accrualwriteoff')),
